						...
						try
						{
							...
							if(!rootTag.hasKey("Level"))
							{
								...
								if(xPos == chunkX && zPos == chunkZ)
								{
									...
									int i = tagList.remove("PrimedTnt");
									System.out.println("Tnt in chunk file at " + chunkX + "," + chunkZ + " removed: " + i);
									Main.out.append("Tnt in chunk file at " + chunkX + "," + chunkZ + " removed: " + i);
									Main.out.newLine();
