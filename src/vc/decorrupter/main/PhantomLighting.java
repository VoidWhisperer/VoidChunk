						...
						try
						{
							...
							if(!rootTag.hasKey("Level"))
							{
								...
								if(xPos == chunkX && zPos == chunkZ)
								{
									...
									{
										System.out.println("Reseting chunk lighting at "+xPos+","+zPos+" section " + i + " for corruption");
										Main.out.append("Reseting chunk lighting at "+xPos+","+zPos+" section " + i + " for corruption");
										Main.out.newLine();
